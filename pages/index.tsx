...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>EFTDM - Start from Scratch with Requirements</title>
        <meta name="description" content="Provide your requirements and get a complete, ready-to-use project structure for Cursor IDE." />
